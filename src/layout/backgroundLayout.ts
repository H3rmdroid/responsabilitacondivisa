import { desktopVhToVw, mobileVhToScaledPx, mobileVwToScaledPx } from "./scale";
...
export const getBackgroundLayout = (isDesktop: boolean): BackgroundLayout => {
  ...
  const backgroundSvg: BackgroundSvgLayout = isDesktop
    ...
    : {
        containerHeight: mobileVhToScaledPx(100),
        containerTop: "0px",
        containerLeft: "0px",
        containerRight: "0px",
        svgTop: 0,
        svgLeft: "50%",
        svgWidth: mobileVwToScaledPx(109),
        svgMaxWidth: "2000px",
        svgTransform: "translateX(-50%)",
        svgPreserveAspectRatio: "xMidYStart meet",
      };
  ...
  const threadsSvg: ThreadsSvgLayout = isDesktop
    ...
    : {
        ...
        pathCap: 1,
        stickyRelease: 0.36,
        containerTop: mobileVhToScaledPx(269),
        containerLeft: "0px",
        containerRight: "0px",
        containerHeight: mobileVhToScaledPx(100),
        svgTop: 0,
  ...
  const threadsSvg2: ThreadsSvg2Layout = isDesktop
    ...
    : {
        opacityRange: [0, 0.08],
        pathCap: 1,
        containerTop: mobileVhToScaledPx(327),
        containerLeft: "0px",
        containerRight: "0px",
        containerHeight: mobileVhToScaledPx(100),
        svgTop: 0,
  ...
  const decorativeSvg: DecorativeSvgLayout = isDesktop
    ? {
        containerTop: desktopVhToVw(474),
        containerLeft: "0px",
        containerRight: "0px",
        containerHeight: desktopVhToVw(100),
        svgWidth: "100vw",
    ...
    : {
        containerTop: mobileVhToScaledPx(150),
        containerLeft: "0px",
        containerRight: "0px",
        containerHeight: mobileVhToScaledPx(100),
        svgTop: 0,
